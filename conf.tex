...
\usepackage[
    ...
    inner=4cm,   % margen interior (gutter)
...
\setlength{\parskip}{6pt} % definimos la separación entre párrafos
\setlength{\parindent}{0pt} % definimos la identación de los párrafos
